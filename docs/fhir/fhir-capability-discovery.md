...
This is **not** Patient search (Task 035), Patient read (Task 036), Condition search (Task 037), Observation search (Task 038), DiagnosticReport search (Task 039), MedicationRequest search (Task 040), or the Task 041 snapshot. Tokens are not fetched or persisted for `/metadata`.

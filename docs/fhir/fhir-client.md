...
See [fhir-error-handling.md](fhir-error-handling.md) and [fhir-resilience.md](fhir-resilience.md). Routed Patient READ goes through the configured resilience pipeline outside `FhirService`. There is no global HTTP exception handler.

...
| `vendor.epic` | Epic sandbox profile, SMART start/callback orchestration, readiness, public metadata capability discovery | Patient read, Hyperspace, `private_key_jwt` |
...
| `vendor.epic` | Epic profile / validator unit tests, `EpicIntegrationProfileIT`, sandbox SMART, and capability-discovery ITs |

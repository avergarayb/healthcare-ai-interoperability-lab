...
│
├── aiconsumerenforcementverification
│   ├── AiConsumerClinicalDataEnforcementExecutionVerificationStatus.java
│   ├── AiConsumerClinicalDataEnforcementExecutionVerificationReasonCodes.java
│   ├── AiConsumerClinicalDataEnforcementExecutionVerificationOperations.java
│   ├── ClinicalDataEnforcementExecutionVerificationContext.java
│   ├── AiConsumerClinicalDataEnforcementExecutionVerificationInput.java
│   ├── AiConsumerClinicalDataEnforcementExecutionVerificationResult.java
...
│
├── aiconsumerenforcementverificationdecision
│   ├── AiConsumerVerificationDecisionStatus.java
│   ├── AiConsumerVerificationDecisionReasonCodes.java
│   ├── AiConsumerVerificationDecisionOperations.java
│   ├── VerificationDecisionContext.java
│   ├── AiConsumerVerificationDecisionInput.java
│   ├── AiConsumerVerificationDecisionResult.java
│   ├── AiConsumerVerificationDecisionBoundary.java
│   └── web
│       └── AiConsumerVerificationDecisionController.java
│
├── aiconsumerenforcementverificationapproval
│   ├── AiConsumerEnforcementVerificationApprovalStatus.java
│   ├── AiConsumerEnforcementVerificationApprovalReasonCodes.java
│   ├── AiConsumerEnforcementVerificationApprovalOperations.java
│   ├── ClinicalDataEnforcementVerificationApprovalContext.java
│   ├── AiConsumerEnforcementVerificationApprovalInput.java
│   ├── AiConsumerEnforcementVerificationApprovalResult.java
...
| `aiconsumerenforcementverification` | deny-by-default clinical data-access enforcement-execution verification; claimed execution is not evidence | real verification provider, evidence store, FHIR read, OAuth, JWT, SMART, HTTP client, handoff, dispatch, OpenAI, RAG, LangGraph, vendor hosts |
| `aiconsumerenforcementverificationdecision` | deny-by-default verification decision; a verification result is not an approval | real policy engine, authorization provider, FHIR read, OAuth, JWT, SMART, HTTP client, handoff, dispatch, OpenAI, RAG, LangGraph, vendor hosts |
| `aiconsumerenforcementverificationapproval` | deny-by-default verification approval; a decision is not a clinical grant | real policy engine, approval store, FHIR read, OAuth, JWT, SMART, HTTP client, handoff, dispatch, OpenAI, RAG, LangGraph, vendor hosts |
...
aiconsumerenforcementverification ──► aiconsumerenforcementexecution  (consumes AiConsumerClinicalDataEnforcementExecutionResult only; never verifies execution)
aiconsumerenforcementverification.web ──► aiconsumerenforcementverification
aiconsumerenforcementverification.web ──► aiconsumerenforcementexecution / aiconsumerenforcement / aiconsumeraccess / aiconsumerscope / aiconsumerconsent / aiconsumerauthorization / aihandoffauthorization / aiconsumerreadiness / aiconsumerpolicy / aiconsumer / aigateway / firstai / aiboundary / modelboundary
aiconsumerenforcementverificationdecision ──► aiconsumerenforcementverification  (consumes AiConsumerClinicalDataEnforcementExecutionVerificationResult only; never approves verification)
aiconsumerenforcementverificationdecision.web ──► aiconsumerenforcementverificationdecision
aiconsumerenforcementverificationdecision.web ──► aiconsumerenforcementverification / aiconsumerenforcementexecution / aiconsumerenforcement / aiconsumeraccess / aiconsumerscope / aiconsumerconsent / aiconsumerauthorization / aihandoffauthorization / aiconsumerreadiness / aiconsumerpolicy / aiconsumer / aigateway / firstai / aiboundary / modelboundary
aiconsumerenforcementverificationapproval ──► aiconsumerenforcementverificationdecision  (consumes AiConsumerVerificationDecisionResult only; never approves access)
aiconsumerenforcementverificationapproval.web ──► aiconsumerenforcementverificationapproval
aiconsumerenforcementverificationapproval.web ──► aiconsumerenforcementverificationdecision / aiconsumerenforcementverification / aiconsumerenforcementexecution / aiconsumerenforcement / aiconsumeraccess / aiconsumerscope / aiconsumerconsent / aiconsumerauthorization / aihandoffauthorization / aiconsumerreadiness / aiconsumerpolicy / aiconsumer / aigateway / firstai / aiboundary / modelboundary
agent.web ──► agent
...
FhirService → aiconsumerenforcementverification
aiconsumerenforcementexecution → aiconsumerenforcementverification
aiconsumerenforcementverification → vendor.epic
aiconsumerenforcementverification → vendor.oracle
aiconsumerenforcementverification → FhirService
FhirService → aiconsumerenforcementverificationdecision
aiconsumerenforcementverification → aiconsumerenforcementverificationdecision
aiconsumerenforcementverificationdecision → vendor.epic
aiconsumerenforcementverificationdecision → vendor.oracle
aiconsumerenforcementverificationdecision → FhirService
FhirService → aiconsumerenforcementverificationapproval
aiconsumerenforcementverificationdecision → aiconsumerenforcementverificationapproval
aiconsumerenforcementverificationapproval → vendor.epic
aiconsumerenforcementverificationapproval → vendor.oracle
aiconsumerenforcementverificationapproval → FhirService
```

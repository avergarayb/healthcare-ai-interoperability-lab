...
class EpicSandboxClinicalSnapshotServiceTest {
    ...
    void disabledProfileDoesNotCallEpic() {
        ClinicalSnapshotResult result = service().assemble(EpicIntegrationProfileTest.completePublicPkce());
    ...
    void missingPatientIdIsContextNotConfiguredWithoutHttp() {
        ClinicalSnapshotResult result = service().assemble(EpicIntegrationProfileTest.enabledCompletePublicPkce());
    ...
    private EpicSandboxClinicalSnapshotService service() {
        return new EpicSandboxClinicalSnapshotService(

...
class EpicSandboxClinicalProjectionControllerTest {
    ...
    void successPageIsBlind() throws Exception {
        ...
        mockMvc.perform(get("/epic/sandbox/fhir/clinical-projection"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("aiBoundary=PREPARED")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("modelCallAuthorized=false")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("clinicalDataAvailable=true")))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("aiConsumerScopeReferencePresent=false")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString(
                        "aiConsumerRealAuthorizationRequired=true")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString(
                        "aiClinicalDataAccessGrantAvailable=false")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("aiClinicalDataAccessEnforced=false")))

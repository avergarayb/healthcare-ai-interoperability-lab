...
@WebMvcTest(FirstAiController.class)
class FirstAiControllerTest {
    ...
    @Test
    void jsonPayloadIsBlindAndDoesNotExecuteAModel() throws Exception {
        when(provider.currentContract()).thenReturn(completeEpic());

        mockMvc.perform(get("/api/first-ai-component/v1"))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.componentStatus").value("PREPARED"))
    ...
    void htmlPageIsBlind() throws Exception {
        ...
        mockMvc.perform(get("/lab/first-ai-component"))
                .andExpect(status().isOk())
    ...
    void authenticationRequiredIs401AndBlocked() throws Exception {
        ...
        mockMvc.perform(get("/api/first-ai-component/v1"))
                ...
                .andExpect(jsonPath("$.componentStatus").value("BLOCKED"))
    ...
    private static ModelBoundaryContract completeEpic() {
        return new ModelBoundaryContract(
                ...
                Instant.parse("2026-09-12T21:30:00Z"),

...
class OracleSandboxClinicalProjectionServiceTest {
    ...
    void disabledProfileDoesNotCallOracle() {
        ClinicalProjectionResult result = service().assemble(OracleHealthIntegrationProfileTest.completePublicPkce());
    ...
    private OracleSandboxClinicalProjectionService service() {
        return new OracleSandboxClinicalProjectionService(

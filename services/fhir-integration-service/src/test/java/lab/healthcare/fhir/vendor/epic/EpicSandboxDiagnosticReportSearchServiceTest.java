...
class EpicSandboxDiagnosticReportSearchServiceTest {
    ...
    void disabledProfileDoesNotCallEpic() {
        FhirDiagnosticReportSearchResult result =
                service().searchDiagnosticReports(EpicIntegrationProfileTest.completePublicPkce());
    ...
    void missingPatientIdIsContextNotConfiguredWithoutHttp() {
        FhirDiagnosticReportSearchResult result =
                service().searchDiagnosticReports(EpicIntegrationProfileTest.enabledCompletePublicPkce());
    ...
    void blankPatientIdIsContextNotConfiguredWithoutHttp() {
        FhirDiagnosticReportSearchResult result = service().searchDiagnosticReports(enabledWithPatient("   "));
    ...
    void validTokenContextAndCapabilityExecuteGenericSearch() {
        ...
        verify(routingService)
                .searchDiagnosticReports(eq(EpicIntegrationProfile.SANDBOX_SERVER), any(), eq(PATIENT_ID));
    ...
    void dependencyFailureMapsWithoutClinicalPayload() {
        ...
        assertThat(result.outcome()).isEqualTo(FhirDiagnosticReportSearchOutcome.DEPENDENCY_FAILURE);
    ...
    private EpicSandboxDiagnosticReportSearchService service() {
        return new EpicSandboxDiagnosticReportSearchService(

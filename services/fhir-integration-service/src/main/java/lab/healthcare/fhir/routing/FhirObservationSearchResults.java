...
/**
 * Maps transport and FHIR failures onto {@link FhirObservationSearchResult}
 * without copying tokens or clinical payloads.
 */
public final class FhirObservationSearchResults {

    private FhirObservationSearchResults() {
    }

    public static FhirObservationSearchResult succeeded(String destination, Bundle bundle) {
    ...
    public static FhirObservationSearchResult fromFailure(String destination, RuntimeException ex) {

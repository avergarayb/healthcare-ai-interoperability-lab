 ...
 * hosts, tokens, Patient identifiers, or per-resource Oracle clients.
 */
@Component
public class OracleSandboxClinicalSnapshotService {
    ...
    @Autowired
    public OracleSandboxClinicalSnapshotService(
    ...
    public ClinicalSnapshotResult assemble(OracleHealthIntegrationProfile profile) {
        if (profile == null) {

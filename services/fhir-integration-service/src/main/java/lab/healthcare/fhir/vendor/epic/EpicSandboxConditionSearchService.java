 ...
 */
@Component
public class EpicSandboxConditionSearchService {
    ...
    @Autowired
    public EpicSandboxConditionSearchService(
    ...
    public FhirConditionSearchResult searchConditions(EpicIntegrationProfile profile) {
        if (profile == null) {
